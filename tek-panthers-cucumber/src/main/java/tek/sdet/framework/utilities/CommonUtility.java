...
public class CommonUtility extends BaseSetup {
        ...
        public void click(WebElement cardEditButton) {
            this.waitTillClickable(cardEditButton).click();
        }
        ...
        public void scroll() {
            Scrollbar verticalScrollbar = new Scrollbar(Scrollbar.VERTICAL, 0, 10, 0, 100);
